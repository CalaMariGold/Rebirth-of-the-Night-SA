...
namespace Rebirth.Terrain.Generation.Noise
{
    /// <summary>
    ...
    public static class SimplexNoise
    {
        ...
        public static float Generate(float x, float y)
        {
            ...
            var t = (i + j) * g2;
            var baseX0 = i - t; // Unskew the cell origin back to (x,y) space
            var baseY0 = j - t;
            var x0 = x - baseX0; // The x,y distances from the cell origin
            var y0 = y - baseY0;
        ...
        public static float Generate(float x, float y, float z)
        {
            ...
            var t = (i + j + k) * g3;
            var baseX0 = i - t; // Unskew the cell origin back to (x,y,z) space
            var baseY0 = j - t;
            var baseZ0 = k - t;
            var x0 = x - baseX0; // The x,y,z distances from the cell origin
            var y0 = y - baseY0;
            var z0 = z - baseZ0;
